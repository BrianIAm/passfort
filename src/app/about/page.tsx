        ...
        <main className="flex-1 px-8 py-4 max-w-7xl">
            ...
            <div className="mb-8">
                ...
                <p className="text-passfort-vibrant mb-4">
                    PassFort is a free, open-source desktop password manager
                    designed to keep your online credentials secure and easily
                    accessible. Unlike cloud-based alternatives, PassFort
                    operates completely offline, ensuring your passwords never
                    leave your device.
                </p>
            </div>
            ...
            <div className="p-4 rounded-lg border border-passfort-vibrant bg-passfort-vibrant/10 mb-8">
                <h3 className="text-xl font-bold mb-4">
                    How PassFort Keeps You Safe
                </h3>
                <ul className="list-disc list-inside space-y-2 text-passfort-vibrant">
                    <li>
                        Military-grade AES-256 encryption for all stored
                        passwords
                    </li>
                    <li>
                    ...
                    <li>
                        No password storage on our end - everything stays local
                    </li>
            ...
            <div className="mb-8">
                ...
                <ol className="space-y-4 text-passfort-vibrant">
                    <li>
                        ...
                        - This is your key to unlock all other passwords. Make
                        it strong and memorable, or allow us to generate one for
                        you.
                    </li>
                    <li>
                        2.{" "}
                        <span className="font-medium">Add your passwords</span>{" "}
                        - Store credentials for your various online accounts
                        securely.
                    </li>
                    <li>
                        3.{" "}
            ...
            <div className="p-4 rounded-lg border-2 border-red-500 bg-red-500/10 mb-8">
                ...
                <p className="text-red-400">
                    PassFort does not store your master password anywhere. If
                    you forget it, there is no way to recover your stored
                    passwords. Always keep a secure backup of your master
                ...
                <ul className="grid grid-cols-2 gap-4">
                    <li className="p-4 rounded-lg border border-passfort-vibrant bg-passfort-vibrant/10">
                        ...
                        <p className="text-passfort-vibrant">
                            Create strong, unique passwords with customizable
                            options
                        </p>
                    </li>
                    <li className="p-4 rounded-lg border border-passfort-vibrant bg-passfort-vibrant/10">
            ...
            <div className="p-4 rounded-lg border border-passfort-vibrant bg-passfort-vibrant/10">
                ...
                <p className="text-passfort-vibrant mb-4">
                    PassFort is currently in beta. If you encounter any issues
                    or have suggestions, please reach out:
                </p>
                <a
