...
export function KeysIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            className="w-6 h-6"
            fill="currentColor"
...
export function WindowsMaximizeIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            className="w-6 h-6"
            aria-hidden="true"
...
export function WindowsRestoreIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            className="w-6 h-6"
            aria-hidden="true"
